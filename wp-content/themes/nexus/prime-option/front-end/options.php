        ...
        <form method="post" id="the-theme-options">
            ...
            <div class="info top-info is-option-page">
                ...
                <div class="top-layout-bar">
                    ...
                    ?>
                    <input type="submit" value="<?php echo $FRONTEND_STRINGS['ot_activate_layout'];  ?>"
                           class="button-framework user-activate-layout" name="user-activate-layout"
                    ...
                    <?php if ($this->has_xml) { ?>
                    <input type="submit" value="<?php echo $FRONTEND_STRINGS['ot_reload_xml']; ?>"
                           class="button-framework reload-options right"
                           name="reload" style="margin:5px 10px 0 20px;"/>
                    <?php } ?>
