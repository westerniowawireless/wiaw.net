 ...
 * @return string
 */
function prime_options_option_tree_background($value, $settings, $int)
{
    ?>
<div class="option option-background-upload">
    ...
    <div class="section">
        <div class="element">
            ...
            <input type="text" name="<?php echo isset($value->item_name) ? $value->item_name
                    : $value->item_id; ?>[background-color]" id="<?php echo $value->item_id; ?>-picker"
                   value="<?php echo (isset($settings[$value->item_id]['background-color']))
                           ? stripslashes($settings[$value->item_id]['background-color']) : ''; ?>" class="cp_input"/>

            <div id="cp_<?php echo $value->item_id; ?>" class="cp_box">
                <div style="background-color:<?php echo (isset ($settings[$value->item_id]['background-color']))
                        ? $settings[$value->item_id]['background-color']
                        : '#ffffff'; ?>;<?php if (isset($settings[$value->item_id]['background-color'])) {
            ...
            <div class="select_wrapper background-repeat" style="width:152px;">
                <select name="<?php echo isset($value->item_name) ? $value->item_name
                        : $value->item_id; ?>[background-repeat]" class="select">
                    <?php
                                echo '<option value="">background-repeat</option>';
                    foreach (prime_options_recognized_background_repeat() as $key => $repeat) {
            ...
            <div class="select_wrapper background-attachment" style="width:179px;margin:0 0 0 10px;">
                <select name="<?php echo isset($value->item_name) ? $value->item_name
                        : $value->item_id; ?>[background-attachment]" class="select">
                    <?php
                                echo '<option value="">background-attachment</option>';
                        foreach (prime_options_recognized_background_attachment() as $key => $attachment) {
            ...
            <div class="select_wrapper background-position">
                <select name="<?php echo isset($value->item_name) ? $value->item_name
                        : $value->item_id; ?>[background-position]" class="select">
                    <?php
                                echo '<option value="">background-position</option>';
                        foreach (prime_options_recognized_background_position() as $key => $position) {
            ...
            <input type="text" name="<?php echo isset($value->item_name) ? $value->item_name
                    : $value->item_id; ?>[background-image]" id="<?php echo $value->item_id; ?>"
                   value="<?php if (isset($settings[$value->item_id]['background-image'])) {
                       echo $settings[$value->item_id]['background-image'];
                   } ?>" class="upload<?php if (isset($settings[$value->item_id]['background-image'])) {
                echo ' has-file';
            } ?>"/>
