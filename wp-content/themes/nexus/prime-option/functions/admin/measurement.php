 ...
 * @return string
 */
function prime_options_option_tree_measurement($value, $settings, $int)
{
    ?>
<div class="option option-measurement">
    ...
    <div class="section">
        <div class="element">
            ...
            <input type="text" name="<?php echo isset($value->item_name) ? $value->item_name : $value->item_id; ?>[0]"
                   value="<?php if (isset($measurement[0])) {
                       echo htmlspecialchars(stripslashes($measurement[0]), ENT_QUOTES);
                   } ?>" class="measurement"/>
            ...
            <div class="select_wrapper measurement">
                <select name="<?php echo $value->item_id; ?>[1]" class="select">
                    ...
                    foreach (prime_options_measurement_unit_types() as $unit) {
