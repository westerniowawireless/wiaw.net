 ...
 * @return string
 */
function prime_options_option_tree_textarea($value, $settings, $int)
{
    ?>
<div class="option option-textarea">
    ...
    <div class="section">
        <div class="element">
            <textarea name="<?php echo isset($value->item_name) ? $value->item_name : $value->item_id; ?>"
                      rows="<?php echo $int; ?>"><?php
