 ...
 * @return string
 */
function prime_options_option_tree_colorpicker($value, $settings, $int)
{
    ?>
<div class="option option-colorpicker">
    ...
    <div class="section">
        <div class="element">
            ...
            <input type="text" name="<?php echo isset($value->item_name) ? $value->item_name : $value->item_id; ?>"
                   id="<?php echo $value->item_id; ?>"
                   value="<?php echo (isset($settings[$value->item_id])) ? stripslashes($settings[$value->item_id])
                           : ''; ?>" class="cp_input"/>

            <div id="cp_<?php echo $value->item_id; ?>" class="cp_box">
                <div style="background-color:<?php echo (isset ($settings[$value->item_id]))
                        ? $settings[$value->item_id] : '#ffffff'; ?>;<?php if (isset($settings[$value->item_id])) {
                    echo 'background-image:none;border-color:' . $settings[$value->item_id] . ';';
                } ?>">
                </div>
            </div>
