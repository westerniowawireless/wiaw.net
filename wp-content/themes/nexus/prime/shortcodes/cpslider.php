...
function prime_shortcode_cp_slider($atts, $content = null)
{
...
<div class="cpslider-wrapper slider-wrapper">
    <div class="cpslider-inner-wrap">
        ...
        <div
            ...
            <?php
            $args = $prime_cp_slider->get_slide_args_for($sc_args);
            ...
            <div class="slide" <?php echo $prime_cp_slider->get_data_height_attrs(); ?>>
                <?php
                echo $prime_cp_slider->get_slide_image();
                echo $prime_cp_slider->get_slide_content();
                ?>
            </div>
