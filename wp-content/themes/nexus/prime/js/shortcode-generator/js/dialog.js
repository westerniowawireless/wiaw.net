var shortcode_generator_url = PrimeSCGen['prime_framework_url'] + 'js/shortcode-generator/';
...
var primeDialogHelper = {
            ...
            for (var c in a) {
                ...
                switch (d) {
                    ...
                    case "multiselect-control":
                        ...
                        this.createMultiselectControl(a[c], f, c == 0);
    ...
    createTextControl:function (a, b, c) {
        ...
        jQuery('<input type="text">').attr("id", g).attr("name", g).attr('value', defaultValue).addClass(f).addClass(d).addClass('txt input-text').addClass(c ? "prime-focus-here" : "").appendTo(b);
    ...
    createMultiselectControl:function (a, b, c) {
        var f = a.validateLink ? "prime-validation-marker" : "",
            d = a.isRequired ? "prime-required" : "",
            g = "prime-value-" + a.id;

        b.addClass('prime-marker-multiselect-control');

        var selectNode = jQuery('<select>').attr('multiple', 'multiple').attr("id", g).attr("name", g).addClass(f).addClass(d).addClass(c ? "prime-focus-here" : "");
    ...
    createFontControl:function (a, b, c) {
        ...
        var selectBoxValues = PrimeSCGen['fonts'];
    ...
    makeShortcode:function () {
        ...
        jQuery("#prime-options-table td").each(function () {
            ...
            if (e = h.hasClass("prime-marker-multiselect-control") ? b.getSelectKeyValue(h) : b.getTextKeyValue(h)) a[e.key] = e.value;
