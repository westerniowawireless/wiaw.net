...
-----------------------------------------------------------------------------------*/
	...
	function Prime_Shortcode_Generator () {
...
-----------------------------------------------------------------------------------*/
	...
	function filter_mce_external_plugins( $plugins ) {
        ...
        $plugins['PrimeShortcodes'] = $this->framework_url() . 'js/shortcode-generator/editor_plugin.js';
...
$prime_shortcode_generator = new Prime_Shortcode_Generator();
?>